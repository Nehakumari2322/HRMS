...
<div class="container-fluid" style="padding:0">
    <div class="row ">
        <div class="col-sm-3 pt-5" style="padding-left:0px;padding-right:0px">
            <?php require APPROOT . '/views/inc/sidenavbar.php';?>
        </div>
        <div class="col-sm-9 mt-5">
            <div class="row mt-5 p-1">
                <div class="col-sm-3 mt-2">
                    <div class="card p-3 pt-3" style="background:#c10505;color:white">
                        <p> <i class="fa-solid fa-user px-4"></i> <?php echo $data['user']?> / Users</p>
                    </div>
                </div>
                <div class="col-sm-3 mt-2">
                    <div class="card p-3 pt-3" style="background:#ED7117;color:white">
                        <p> <i class="fa-solid fa-network-wired px-4"></i> <?php echo $data['client']?>  / Clients</p>
                    </div>
                </div>
                <div class="col-sm-3 mt-2">
                    <div class="card p-3 pt-3" style="background:blue;color:white">
                        <p> <i class="fa-solid fa-file px-4"></i><?php echo $data['project']?>  / Project</p>
                    </div>
                </div>
                <div class="col-sm-3 mt-2">
                    <div class="card p-3 pt-3" style="background:green;color:white">
