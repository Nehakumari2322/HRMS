...
// new project
    ...
    public function getLeadDetails(){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id ORDER BY l.created_ts DESC');
        $row = $this->db->resultSet();
        return $row;
    }
    ...
    public function getLeadDetailsWithClient($client_id){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id AND p.c_id = :client_id ORDER BY l.created_ts DESC');
        $this->db->bind(':client_id',$client_id);
        $row = $this->db->resultSet();
        return $row;
    }
    ...
    public function getLeadDetailsWithProject($project_id){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id AND p.p_id = :project_id ORDER BY l.created_ts DESC');
    ...
    public function getLeadDetailsWithStatus($status){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id AND l.status = :status ORDER BY l.created_ts DESC');
        $this->db->bind(':status',$status);
        $row = $this->db->resultSet();
        return $row; 
    }
    ...
    public function getLeadDetailsWithVendor($vendor){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id AND l.assign_to = :vendor ORDER BY l.created_ts DESC ');
    ...
    public function getLeadDetailsWithClientAndProject($client_id,$project_id){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id AND p.c_id = :client_id AND p.p_id = :project_id ORDER BY l.created_ts DESC');
        $this->db->bind(':client_id',$client_id);
        $this->db->bind(':project_id',$project_id);
        $row = $this->db->resultSet();
        // print_r($row);
    ...
    public function getLeadDetailsWithClientAndProjectAndStatus($client_id,$project_id,$status){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id AND p.c_id = :client_id AND p.p_id = :project_id AND l.status= :status ORDER BY l.created_ts DESC');
        $this->db->bind(':client_id',$client_id);
        $this->db->bind(':project_id',$project_id);
        $this->db->bind(':status',$status);
        $row = $this->db->resultSet();
    ...
    public function getLeadDetailsWithClientAndProjectAndStatusAndVendor($client_id,$project_id,$status,$vendor){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,l.assign_to,l.requirement FROM lead l,project p WHERE l.p_id = p.p_id AND p.c_id = :client_id AND p.p_id = :project_id AND l.status= :status AND l.assign_to =:vendor ORDER BY l.created_ts DESC');
        $this->db->bind(':client_id',$client_id);
        $this->db->bind(':project_id',$project_id);
        $this->db->bind(':status',$status);
        $this->db->bind(':vendor',$vendor);
    ...
    public function getLeadDetailsOfId($lead_id){
        $this->db->query(' SELECT l.l_id,l.name,l.email,l.phone, l.status, l.source, l.vendor_remarks, l.client_remarks, l.created_ts, l.updated_ts,p.name as project_name,c.name as client_name,l.created_by,l.assign_to,l.requirement FROM lead l,project p,client c WHERE l.p_id = p.p_id AND p.c_id = c.c_id AND l.l_id =:lead_id  ');
        $this->db->bind(':lead_id',$lead_id);
        $row = $this->db->single();
        return $row; 
    }

    public function updateStatusOfLead($lead_id,$status,$lastUpdatedTs,$lastUpdatedBy){
        $this->db->query(' UPDATE lead SET status=:status , updated_ts=:lastUpdatedTs, updated_by=:lastUpdatedBy WHERE l_id= :lead_id');
        $this->db->bind(':lead_id',$lead_id); 
        $this->db->bind(':status',$status);                
    ...
    public function updateVendorName($l_id,$assignto,$lastUpdatedTs,$lastUpdatedBy){
        $this->db->query(' UPDATE lead SET assign_to= :assignto , updated_ts=:lastUpdatedTs, updated_by=:lastUpdatedBy WHERE l_id = :l_id');
